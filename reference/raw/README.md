...
`raw/`는 공식 원자료를 가리키는 날짜별 증거 레이어다. 저작권이 있는 외부 문서를 통째로 복제하지 않고 다음만 기록한다.
...
과거 스냅샷은 수정하지 않는다. 새로운 조사 결과는 새 날짜 파일로 추가하고 `reference/wiki/`의 현재 문서를 갱신한다.
...
- [2026-07-11 한국어 체크리스트 UX 검증](remote-checklist-ux-verification-2026-07-11.md)
- [2026-07-11 직접 입력·가변 목록·상세 화면 검증](remote-dynamic-task-flow-verification-2026-07-11.md)
